...
//Last modified: Thu, Apr 12, 2018 02:59:29 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 72.928745023094919 11.993959651926231 5.2539675901785108 ;
	setAttr ".r" -type "double3" -1.5383527280886053 -3155.8000000000784 -9.8353429291461272e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A7CFE7F0-4F5A-8A2E-F9CF-548727D5D07B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 75.570740924758383;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 9.5161679375232922 -0.40002137249210912 ;
...
createNode transform -n "pPipe1";
	...
	setAttr ".s" -type "double3" 0.7753513735527866 0.92519177632099403 0.75655348869299022 ;
createNode mesh -n "pPipeShape1" -p "pPipe1";
	...
	setAttr ".pt[80]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[81]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[82]" -type "float3" 0.069121152 -0.15764749 0.00069929857 ;
	setAttr ".pt[83]" -type "float3" 0.25209931 -0.13687699 5.9604645e-008 ;
	setAttr ".pt[84]" -type "float3" 0 0 5.9604645e-008 ;
	setAttr ".pt[86]" -type "float3" 0 0 5.9604645e-008 ;
	setAttr ".pt[87]" -type "float3" -0.25209931 -0.13687699 2.9802322e-008 ;
	setAttr ".pt[88]" -type "float3" -0.069121167 -0.15764749 0.00069929857 ;
	setAttr ".pt[89]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[90]" -type "float3" 0 -0.13687699 -2.3841858e-007 ;
	setAttr ".pt[91]" -type "float3" 0 -0.13687699 2.9802322e-007 ;
	setAttr ".pt[92]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[93]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[94]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[95]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[96]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[97]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[98]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[99]" -type "float3" 0 -0.13687699 0 ;
	setAttr ".pt[100]" -type "float3" 0 -0.1515433 -1.6462406 ;
	setAttr ".pt[101]" -type "float3" 0 -0.1515433 -1.6462406 ;
	setAttr ".pt[102]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[103]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[104]" -type "float3" 0 -0.1515433 -1.6462406 ;
	setAttr ".pt[105]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[106]" -type "float3" 0 -0.1515433 -1.6462406 ;
	setAttr ".pt[107]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[108]" -type "float3" 0 -0.1515433 -1.6462406 ;
	setAttr ".pt[109]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[110]" -type "float3" 0 -0.1515433 -1.6462406 ;
	...
	setAttr ".pt[116]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[117]" -type "float3" 0 -0.1515433 -1.6462406 ;
	...
	setAttr ".pt[123]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[124]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[125]" -type "float3" 0 -0.1515433 -1.6462406 ;
	...
	setAttr ".pt[131]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[132]" -type "float3" 0 -0.1515433 -1.6462406 ;
	...
	setAttr ".pt[138]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[139]" -type "float3" 0 -0.1515433 -1.6462406 ;
	...
	setAttr ".pt[145]" -type "float3" 0 -0.13687699 -1.6462406 ;
	setAttr ".pt[146]" -type "float3" 0 -0.1515433 -1.6462406 ;
...
createNode transform -n "pCylinder1";
	...
	setAttr ".t" -type "double3" 0 5.874638890461334 0 ;
	setAttr ".s" -type "double3" 0.56316141745206261 5.0849872990363076 0.56316141745206261 ;
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	rename -uid "3BA5AE93-4573-BF69-978C-19891A31A9B4";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.49999988079071045 0.66494357585906982 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 20 ".pt[202:221]" -type "float3"  0.0040905504 0 0.0013686423 
		0.0034796298 0 0.002603312 0.0025280993 0 0.0035831509 0.0013291008 0 0.0042122467 
		3.8454465e-010 0 0.0044290181 -0.0013291 0 0.0042122472 -0.0025280998 0 0.0035831509 
		-0.0034796298 0 0.0026033118 -0.0040905504 0 0.0013686424 -0.0043010591 0 7.9196988e-010 
		-0.0040905504 0 -0.0013686412 -0.0034796298 0 -0.0026033104 -0.0025280993 0 -0.0035831511 
		-0.0013291007 0 -0.0042122467 5.1272614e-010 0 -0.0044290181 0.0013291014 0 -0.0042122472 
		0.0025281007 0 -0.0035831509 0.0034796321 0 -0.0026033118 0.0040905531 0 -0.0013686416 
		0.0043010591 0 7.9196988e-010;
	setAttr ".ai_translator" -type "string" "polymesh";
