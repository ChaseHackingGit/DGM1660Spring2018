...
//Last modified: Sat, Mar 31, 2018 10:42:52 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.8824967569866988 3.7117882596679879 -5.9544594276745668 ;
	setAttr ".r" -type "double3" -15.938352729442581 497.79999999979367 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "BD371D50-4F0E-2428-5DB7-C6BEDADC35A3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.2654912210689595;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.5468593284995262 1000.1 1.6675984180428021 ;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 2.0163098789504961 -1.2169574851862492 ;
...
createNode transform -n "polySurface8" -p "pCube17";
	...
	setAttr ".t" -type "double3" -1 1.8041124150158794e-16 3.3306690738754696e-16 ;
...
createNode transform -n "polySurface9" -p "pCube17";
	...
	setAttr ".t" -type "double3" -3 4.3021142204224816e-16 8.8817841970012523e-16 ;
...
createNode transform -n "polySurface10" -p "pCube17";
	...
	setAttr ".t" -type "double3" -2 1.1102230246251565e-15 6.6613381477509392e-16 ;
